<template>
    ...
    <div v-for="i in store.maxColumns" :key="i"
        ...
        <button class="absolute items-center justify-center p-0.5 left-1 bg-slate-300 hidden rounded group-hover:flex"
        ...
        <div class="absolute right-0 hidden cursor-col-resize group-hover:flex text-slate-500">|</div>
    </div>
</template>
