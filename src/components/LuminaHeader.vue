<template>
    <div class="flex">
        ...
        <div v-for="i in store.maxColumns" :key="i" class="relative flex flex-shrink-0 items-center justify-center font-semibold w-20 h-6 border p-0.5 bg-slate-100 group" :class="{ 'bg-slate-200': i - 1 === store.activeCell.cellIndex }">
